...
(*décommenter les lignes suivantes pour éxecuter depuis le toplevel*)
...
(* ocamlfind ocamlc -package graphics  unix.cma -linkpkg projet_v051c.ml *)
...
snow, koch1, koch2, koch3, koch4, koch5, dragon, sierp, 6gosp, 4gosp, plant, plant3d, br1, br2, cantor\n";
  ...
  prerr_endline "Erreur : n doit être un entier positif et non nul.\n";
  exit 0
end
;;
...
let rec rewrite rws brack =
  let in_rewrite rws brack = match brack with

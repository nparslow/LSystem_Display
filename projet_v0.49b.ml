(* pour compiler:
 comment chaque line "load"
 ocamlc unix.cma graphics.cma -o projet.o projet_v049b.ml
 *)
...
let rec rec_draw k chaine rws interpretation point_depart echelle grow scale_factor iter clear =
...
draw w_snow s_snow i_snow 3 false false;;
...
draw w_cantor s_cantor i_cantor 2 false false;;

(* a faire: ne monte a chaque appelle, reste sur la difference de check_echelle et check_largeur et que on veut
move dans le deuxieme et pas dans le premier (?) *)
clear_graph();;
